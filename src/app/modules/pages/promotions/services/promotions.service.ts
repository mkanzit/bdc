...
export class PromotionsService {
  ...
  constructor() {
    this.promotions = {
      ...
      'anchors': {
        'title': 'Liens interne',
        'links': [
          { 'href': '#', 'title': 'lien', 'text': '1- Lorem ipsum dolor promotions' },
          { 'href': '#', 'title': 'lien', 'text': '2- Lorem ipsum dolor promotions' },
          { 'href': '#', 'title': 'lien', 'text': '3- Lorem ipsum dolor promotions' },
          { 'href': '#', 'title': 'lien', 'text': '4- Lorem ipsum dolor promotions' }
        ]
      },
      'blocks': [
        {
          ...
          'content': [
            {
              ...
              'content': [
                ...
                'Bénéficier d’un réseau 4G performant.',
                'Profiter d’un forfait sans engagement.',
  ...
  getPromotionsDetailsArab() {
    return this.detailsArab;
  }
