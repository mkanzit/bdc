...
Parsley.addMessages('ar', {
    ...
    login: "تاكد من رمز الادخال",
    unexpected: "طرأ خطأ غير متوقع. المرجو تكرار المحاولة لاحقاً",
    otp: "رمز التشغيل غير صحيح."
});

Parsley.setLocale('ar');

$('.table-wrapper .fluid-table table tbody tr th').attr('data-th',  'نوع دي التغذية'); 